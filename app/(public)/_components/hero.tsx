    ...
    <section className="bg-white">
        <div className="container mx-auto px-4 pt-20 pb-4 sm:pb-0 sm:px-6 lg:px-8">
            ...
            <main className="flex items-center justify-center">
                <article className="max-w-3xl space-y-8 flex-col justify-center">
                    <h1 className="text-4xl lg:text-5xl font-bold max-w-2xl tacking-tight">
                    ...
                    <Button className="bg-emerald-500 hover:bg-emerald-400 w-fit px-6 font-bold">
